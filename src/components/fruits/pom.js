		...
		<div className="pom_container">
			<div className="total_pom">
				...
				<div className="pom_top">
					{/* Top Triangles */}
					<div className="tops">
						<div className="pom_top1" />
						<div className="pom_top2" />
						<div className="pom_top3" />
					</div>
					<div className="pom_top_base" />
				</div>
					...
					<div className="pom_inner">
						...
						<div className="all_pom_seeds">
							...
							<div className="pom_seeds1 pom_seeds">
								<div className="pom_seed3 pom_seeds" />
								<div className="pom_seed1 pom_seeds" />
								<div className="pom_seed2 pom_seeds" />
								<div className="pom_seed3 pom_seeds" />
							</div>
              ...
              <div className='pom_seed1 pom_seeds'></div>
							...
							<div className="pom_seeds4 pom_seeds">
								...
								<div className="pom_seed2 pom_seeds" />
								<div className="pom_seed3 pom_seeds" />
								<div className="pom_seed1 pom_seeds" /> <div className="pom_seed2 pom_seeds" />
							</div>
						...
						<div className="pom_inner_line" />
					</div>
				</div>
			</div>

			<div className="pom_shadow" />
		</div>
	);
}
